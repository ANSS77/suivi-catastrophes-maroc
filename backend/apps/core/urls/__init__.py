...
from apps.core.views.user_views import UserListView, ToggleUserView, DeleteUserView
...
urlpatterns = [
    ...
    path('admin/users/<str:user_id>/delete/', DeleteUserView.as_view(), name='users-delete'),
] 
